		...
		<div id="comments" class="comments-area">
			...
			?>
				...
				?>
					<nav>
						<ul class="pager">
							<li class="previous"><?php previous_comments_link( __( '&larr; Older Comments', 'di-business' ) ); ?></li>
							<li class="next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'di-business' ) ); ?></li>
						</ul>
					</nav>
				<?php
				}
