    ...
    <div class="container-fluid" style="border:2px solid #ADADAD;">
        <div class="row">
            <div class="col-md-6" style="padding:0px;">
                <img class="img-responsive" src="<?php echo get_template_directory_uri() . '/screenshot.png'; ?>" />
            </div>
            <div class="col-md-6">
            <h2><?php _e( 'Di Business WordPress Theme', 'di-business' ); ?></h3>
            ...
            ?>
            <a target="_blank" class="btn btn-success" href="http://demo.dithemes.com/di-business/" role="button"><?php _e( 'Theme Demo', 'di-business' ); ?></a>
            <a target="_blank" class="btn btn-success" href="https://dithemes.com/di-business-free-wordpress-theme-documentation/" role="button"><?php _e( 'Theme Docs', 'di-business' ); ?></a>
            <a target="_blank" class="btn btn-success" href="<?php echo get_dashboard_url().'customize.php'; ?>" role="button"><?php _e( 'Theme Options', 'di-business' ); ?></a>
            <?php
            if( function_exists( 'di_business_pro' ) ) {
                ?>
                <a target="_blank" class="btn btn-success" href="https://dithemes.com/my-tickets/" role="button"><?php _e( 'Get Premium Support', 'di-business' ); ?></a>
                <?php
            } else {
                ?>
                <a target="_blank" class="btn btn-success" href="https://dithemes.com/product/di-business-pro-wordpress-theme/" role="button"><?php _e( 'Get Di Business Pro', 'di-business' ); ?></a>
                <?php
            }
            ?>
            <br /><br />
...
function di_business_admin_js_css() {
    // Load bootstrap css.
    wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/assets/css/bootstrap.css', array(), '3.3.6', 'all' );
    // Load bootstrap js.
    wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/assets/js/bootstrap.js', array( 'jquery' ), '3.3.6', true );
}
