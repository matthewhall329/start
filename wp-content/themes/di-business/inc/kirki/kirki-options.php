...
Kirki::add_field( 'di_business_config', array(
	...
	'description' => esc_attr__( 'Used as Headline of Widgets, Posts on Archive, Comment Box, Site Title.', 'di-business' ),
	'section'     => 'typography_options',
	'default'     => array(
		'font-family'    => 'Arvo',
		'variant'        => 'regular',
...
Kirki::add_field( 'di_business_config', array(
	...
	'label'			=> esc_attr__( 'Google Plus Link', 'di-business' ),
	'description'	=> esc_attr__( 'Leave empty for disable', 'di-business' ),
	'section'		=> 'social_options',
	'default'		=> '',
) );
...
if( class_exists( 'WooCommerce' ) )
{
	...
	Kirki::add_field( 'di_business_config', array(
		...
		'section'     => 'woocommerce_options',
		'default'     => '<hr /><div style="padding: 10px;background-color: #333; color: #fff; border-radius: 8px;">' . esc_attr__( 'This layout will apply on Shop, Single Product and Product Search Pages. If you want to set full width for Cart, Checkout and My Account pages, then edit these pages and select Full Width No Sidebar Template.', 'di-business' ) . '</div>',
	) );

	Kirki::add_field( 'di_business_config', array(
		'type'        => 'radio-image',
		'settings'    => 'woo_layout',
		'label'       => esc_attr__( 'WooCommerce Page Layout', 'di-business' ),
		'section'     => 'woocommerce_options',
		'default'     => 'fullw',
		'choices'     => array(
			'fullw'	  => get_template_directory_uri() . '/assets/images/fullw.png',
