 ...
 * @access public
 */
class Themehunk_Customizer_Range_Value_Control extends WP_Customize_Control {
	...
	/**
	 * Themehunk_Customizer_Range_Value_Control constructor.
	 *
	...
	public function enqueue() {
		wp_enqueue_script( 'customizer-range-value-control', THEMEHUNK_CUSTOMIZER_PLUGIN_URL . 'shopline/customizer/customizer-range-value/js/customizer-range-value-control.js', array( 'jquery', 'customize-base' ), '1.0.0', true );
		wp_enqueue_style( 'customizer-range-value-control', THEMEHUNK_CUSTOMIZER_PLUGIN_URL . 'shopline/customizer/customizer-range-value/css/customizer-range-value-control.css', array(), '1.0.0' );
	}
	...
	public function json() {
		...
		$json['vals'] = json_encode( $this->input_attr );
 ...
 * @since 1.1.38
 */
function themehunk_sanitize_range_value( $input ) {
	if ( themehunk_is_json( $input ) ) {
