...
.commentlist .reply a:hover, #cancel-comment-reply-link:hover, .commentlist b.fn{
color: $theme_color;
}
...
.ui-slider .ui-slider-range{background: none repeat scroll 0 0 $theme_color;
...
.woocommerce .woocommerce-product-rating .star-rating,.woocommerce ul.products li.product .star-rating, .comment-text .star-rating, .woocommerce p.stars a,.woocommerce .footer-widget .star-rating span, .woocommerce .star-rating::before, #shopline-popup-boxes .star-rating span, .woocommerce #best_sell_section ul.product_list_widget li .star-rating, .woocommerce .mega .thunk-widget-menu ul.product_list_widget li .star-rating{color:{$shop_ratng_color};}
...
.woocommerce button.button.alt, .woocommerce li.product .button{border: 2px solid $shop_btn_color; color:$shop_btn_color;}
.woocommerce button.button.alt:hover, .woocommerce li.product .button:hover{background: $shop_btn_color; border-color:$shop_btn_color;}
.woocommerce button.button.alt.disabled, .woocommerce button.button.alt.disabled:hover{
  background-color: $shop_btn_color;
    border: 2px solid $shop_btn_color;}
...
$shopline_style   .="header{ background:{$headr_bckg};} header.shrink{ background:{$shrnk_headr_bckg};}
.header-wrapper .site-title a{color:{$site_title_color};}p.site-description{color:{$site_desc_color};}
...
.cart-widget .fa-shopping-cart, .header-extra .fa-heart, .header-extra ul.hdr-icon-list li.accnt a.logged-in:before, .header-extra ul.hdr-icon-list li.accnt a.logged-out:before{color:{$top_icon_color};}
...
$shopline_style .="#slider-div .slides li:before {background:{$normal_slider_bg_overly};}
.flexslider .container_caption a.slider-button{border-color:$sldr_btn_brd_clr; color:$sldr_btn_txt_clr; background:$slider_bg_clr;}
.flexslider .container_caption a.slider-button:hover{background:$slider_bg_hvr_clr; color:$sldr_btn_hvr_txt_clr; border-color:$sldr_btn_hvr_brd_clr;}
.flexslider .container_caption h2 a{color:$sldr_heading_clr;}
.flexslider .container_caption p{color:$sldr_subheading_clr;}";


//search box
$search_box_bg_color    = get_theme_mod('search_box_bg_color','#fff');
$search_box_border_color  = get_theme_mod('search_box_border_color','#bbb');
$search_box_text_color    = get_theme_mod('search_box_text_color','#bbb');
$search_box_btn_bg_color    = get_theme_mod('search_box_btn_bg_color','#e7c09c');
$search_box_icon_color      = get_theme_mod('search_box_icon_color','#fff');
$shopline_style .=".search_1{background:{$search_box_bg_color};
          color:{$search_box_text_color};
          border-color:{$search_box_border_color}; }
.submit_1{ background-color:{$search_box_btn_bg_color}; }
.submit_1:before{color:{$search_box_icon_color};}";
//woo category slider
...
#category_section:before{ background:{$woo_cate_slider_overly};}";
...
#ribbon_section:before{ background:{$ribbn_img_overly_color};}";
if($ribbon_bg_options == 'video'):
$shopline_style .=".vedio-ribbon{background:url();}"; 
endif;
if($ribbon_bg_options == 'image'):
$ribbon_bg_image = get_theme_mod('ribbon_bg_image',RIBBON_BG_IMAGE);
...
.featured-grid .product-block span.onsale, .woocommerce .product-image-wrapper span.onsale  {
    ...
    .featured-grid .product-block span.onsale, .woocommerce .product-image-wrapper span.onsale {
    color: {$woo_cate_product_sale_text_color};}";
...
#testimonial_section:before{ background:{$tst_img_overly_color};}";
...
section#post_section{background-color:{$blog_overly};}";
...
$shopline_style .= "div#hot_sell_section{background-color:{$three_column_ads_bg_color};}";
...
.footer-widget-column .widget ul li a, .footer-widget .product-title, .footer-widget .total strong, .footer-widget .widget span, .footer-widget .widget span.amount, #shopmain #wp-calendar thead th{color:{$footer_widget_text_color};}
...
.footer-widget .textwidget{color:{$footer_widget_text_color};}";
...
$shopline_style .="body,p,.woocommerce table.shop_table th,.woocommerce table.wishlist_table thead th{ 
  ...
  #shopmain.woocommerce-cart .amount,.woocommerce table .cart_item td span,.woocommerce .amount,.featured-grid .product-block .price > *,.leadform-show-form.leadform-lite textarea,.leadform-show-form.leadform-lite .select-type select{
font-family:{$shopline_body_font};}";
}
