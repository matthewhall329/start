    ...
    <div class="container">
      <div class="amazing-block">
        <ul class="amazing-list">
          <li class="one wow fadeIn" data-wow-duration="3s">
            <?php if($aboutusimg!=''){ ?>
          ...
          <li class="two wow fadeIn" data-wow-duration="3s">
            <div class="flex-abt">
              <?php if($heading!=''){ ?>
...
<section id="post_section" class="lst-post <?php echo esc_html($prlx_class);?>"
  data-center="<?php echo $prlx_data_center;?>"
  data-top-bottom="<?php echo $prlx_top_bottom;?>">
    <div class="container">
      <div class="block-heading wow fadeIn" data-wow-duration="3s">
        <?php if($heading!=''){ ?>
      ...
      <div id="owl-blog" class="owl-carousel owl-theme wow fadeInDown" data-wow-duration="2s">
        <?php
...
?>
  <ul class="sell">
        ...
        <li class="three wow fadeIn" data-wow-duration="3s">
...
<section id="ribbon_section" class="vedio-ribbon <?php echo $prlx_class;?>"
    ...
    data-top-bottom="<?php echo $prlx_top_bottom;?>">
        ...
        <?php endif;?>
        <?php endif; ?>
        <div class="title-wrap wow fadeIn" data-wow-duration="3s">
...
<section id="testimonial_section" class="testimonial <?php echo $prlx_class;?>" 
 data-center="<?php echo $prlx_data_center;?>"
  ...
  <div class="container">
    ...
    <div class="testimonial-block wow fadeInDown" data-wow-duration="2s">
  ...
  data-top-bottom="<?php echo $prlx_top_bottom;?>">
    <div class="container">
      <div class="imagecat-block">
        ...
        <!-- grid-slider-layout -->
        <div class="cat-grid owl-carousel wow fadeInDown" data-wow-duration="2s">
