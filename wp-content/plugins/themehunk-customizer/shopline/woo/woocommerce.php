...
function shopline_woo_product(){
  ...
  if($catetype=='cate'){
    ...
    shopline_recent_contegory_product();
  }
}
endif;
...
function shopline_woo_category_list($category_list){
  $cate_list = '<div class="block-heading wow fadeIn" data-wow-duration="3s">'.shopline_woo_product_heading().'
...
function shopline_woo_category_product_grid($productArr){
  $product_list = '<li class="featured-isotope cd-item featured-list '.$productArr['slug'].'" id="post-'.$productArr['pid'].'">
                  <div class="product-block">
    ...
    if ( $count > 0 ){
      ...
      foreach ( $product_categories as $product_category ) {
          ...
          $cate_list .= '<div class="featured-block">
                <ul class="poup-product featured-'.$layout.' wow fadeInDown" data-wow-duration="2s">
                   '. $cate_product.'
                </ul></div>';
...
if ( ! function_exists( 'shopline_whish_list' ) ) :
  ...
  function shopline_whish_list(){
     if( shortcode_exists( 'yith_wcwl_add_to_wishlist' ) ) {
        return do_shortcode('[yith_wcwl_add_to_wishlist icon="fa fa-heart-o" browse_wishlist_text=""]' );
      }
  }
  endif;
?>