...
function add_product_sahre_button_func() {
	echo'<div class="social-share"><h3>Share this product</h3><ul>'?>
	 ...
	 <li class="gml-icon"><a target="_blank" href="https://plus.google.com/share?url=<?php esc_url(the_permalink()); ?>"></a><li>
	 <li class="twt-icon"><a target="_blank" href="https://twitter.com/home?status=<?php the_title(); ?>-<?php esc_url(the_permalink()); ?>"></a></li>
	 <li class="paintest-icon"><a data-pin-do="skipLink" target="_blank" href="https://pinterest.com/pin/create/button/?url=<?php esc_url(the_permalink()); ?>&amp;media=&amp;description=<?php the_title(); ?>"></a></li>
