...
<li class="multi-team first">
 ...
 <?php } ?>
  <figcaption>
    ...
    <p><?php echo $text; ?></p>
    <div class="icons"><a href="<?php echo "$fontaws2link" ?>"><i class="<?php echo $fontaws1; ?>" aria-hidden="true"></i></a><a href="<?php echo $fontaws2link ?>"><i class="<?php echo $fontaws2; ?>" aria-hidden="true"></i></a><a href="<?php echo $fontaws3link; ?>"><i class="<?php echo $fontaws3; ?>" aria-hidden="true"></i></a></div>
  </figcaption>
